...
function MobileAdvertence({ children }: Props) {
	...
	return (
		<div className='MobileAdvertence Inventory'>
			<h2>¡Small Screen!</h2>
			<p>
				This site is not intended for mobile devices.
				If you want to see my portfolio, I recommend you visit this other implementation.
			</p>
			<a
				className='Button'
			...
			<button
				className='Button'
				onClick={() => setIgnoredAdvertence(true)}
			>See anyway</button>
		</div>
	);
}
