...
const socialMediaList = [
	{
		...
		name: 'Twitter',
		user: '@VanDeFlame',
		url: 'https://twitter.com/VanDeFlame',
	},
	{
		column: 2,
		row: 2,
		name: 'Instagram',
		user: 'vandeflame',
		url: 'https://www.instagram.com/vandeflame/',
	},
	{
		column: 4,
		row: 1,
		name: 'GitHub',
		user: 'VanDeFlame',
		url: 'https://github.com/VanDeFlame',
	},
	{
		column: 9,
		row: 3,
		name: 'LinkedIn',
		user: 'vandeflame',
		url: 'https://www.linkedin.com/in/vandeflame/',
	},
	{
		column: 4,
		row: 3,
		name: 'Discord',
		user: 'vandeflame',
		url: 'https://discordapp.com/users/819003058427920385',
	},
];
	...
	return (
		<div className='Contact'>
			...
			<GridContainer columns={9} rows={1}>
				<Slot row={1} column={1}>
					<a
						href='mailto:vandeflame@gmail.com?subject=Work'
						rel='noopener noreferrer'
						target='_blank'
					>
						<ItemWithToast
